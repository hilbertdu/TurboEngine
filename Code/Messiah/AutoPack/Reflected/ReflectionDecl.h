...
TREFLECT_BEGIN(ICommand)
	TREFLECT_FIELD(m_Name,			"Name",			ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_Executable,	"Executable",	ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_Parameters,	"Parameters",	ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_WorkingDir,	"WorkingDir",	ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_Environment,	"Environment",	ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_Description,	"Description",	ATTRIBUTE(AttrSerializer(true)))
	TREFLECT_FIELD(m_Author,		"Author",		ATTRIBUTE(AttrSerializer(true)))
