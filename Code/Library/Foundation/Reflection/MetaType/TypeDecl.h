...
#define REFLECTION_CONTAINER_INIT_LIST \
	...
	REFLECTION_DECLARE_CONTAINER(StrongPtr,		RFL_KEY(0), RFL_VALUE(1), RFL_TEMPLATE(T, DELETOR))							\
	REFLECTION_DECLARE_CONTAINER(WeakPtr,		RFL_KEY(0), RFL_VALUE(1), RFL_TEMPLATE(T, DELETOR))
