...
#define REFLECTION_CONTAINER_INIT_LIST \
	REFLECTION_DECLARE_CONTAINER(Array,			KEY(0), VALUE(1), TEMPLATE(T, ALLOCATOR))						\
	REFLECTION_DECLARE_CONTAINER(LinkedList,	KEY(0), VALUE(1), TEMPLATE(T, ALLOCATOR))						\
	REFLECTION_DECLARE_CONTAINER(Pair,			KEY(1), VALUE(2), TEMPLATE(T1, T2))								\
	REFLECTION_DECLARE_CONTAINER(HashMap,		KEY(1), VALUE(2), TEMPLATE(T, DATA, HASHER, EQUAL, ALLOCATOR))	\
	REFLECTION_DECLARE_CONTAINER(StrongPtr,		KEY(0), VALUE(1), TEMPLATE(T, DELETOR))							\
	REFLECTION_DECLARE_CONTAINER(WeakPtr,		KEY(0), VALUE(1), TEMPLATE(T, DELETOR))
