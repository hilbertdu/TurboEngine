...
// Update
//------------------------------------------------------------------------------
/*static*/ uint32 CRC32::Update(uint32 crc32, const void * buffer, size_t len)
{
	const uint8 * bytes = (uint8*)buffer;
...
// UpdateLower
//------------------------------------------------------------------------------
/*static*/ uint32 CRC32::UpdateLower(uint32 crc32, const void * buffer, size_t len)
{
	const uint8 * bytes = (uint8*)buffer;
	for (size_t i = 0; i < len; i++)
	{
...
// Calc
//------------------------------------------------------------------------------
/*static*/ uint32 CRC32::Calc(const void * buffer, size_t len)
{
//	uint32 crc32 = Start();
...
// CalcLower
//------------------------------------------------------------------------------
/*static*/ uint32 CRC32::CalcLower(const void * buffer, size_t len)
{
	uint32 crc32 = Start();
